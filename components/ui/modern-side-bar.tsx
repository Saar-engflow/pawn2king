"use client"; 
 ...
 const navigationItems: NavigationItem[] = [ 
   ...
   { id: "routine", name: "Daily Routine", icon: ListTodo, href: "/routine" }, 
   { id: "goals", name: "Goals", icon: Target, href: "/goals" }, 
   { id: "journal", name: "Journal", icon: BookText, href: "/journal" }, 
   { id: "addiction", name: "Addiction Tracker", icon: Activity, href: "/addiction" }, 
 ...
 export function Sidebar({ className = "" }: SidebarProps) { 
   ...
   const [profile, setProfile] = useState<{ full_name: string | null; rank: string | null; avatar_url: string | null } | null>(null);
           ...
           {!isCollapsed && ( 
             <div className="flex items-center space-x-2.5"> 
               ...
               <div className="flex flex-col"> 
                 <span className="font-semibold text-slate-800 text-base">pawn2king</span> 
               </div> 
             </div> 
           )} 
             ...
             {!isCollapsed ? ( 
               ...
               > 
                 ...
                 <div className="flex-1 min-w-0 ml-2.5"> 
                   <p className="text-sm font-bold text-slate-800 truncate">{profile?.full_name || 'New King'}</p> 
                   <p className="text-[10px] font-black uppercase tracking-widest text-indigo-500 truncate">{profile?.rank || 'Pawn'}</p> 
                 </div> 
               ...
               > 
                 <div className="relative"> 
                   <div className="w-9 h-9 bg-indigo-600 rounded-full flex items-center justify-center overflow-hidden shadow-sm"> 
                     {profile?.avatar_url ? (
                       <img src={profile.avatar_url} alt="Profile" className="w-full h-full object-cover" />
                     ) : (
